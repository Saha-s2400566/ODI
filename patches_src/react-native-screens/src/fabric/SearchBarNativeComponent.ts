...
interface NativeCommands {
  blur: (viewRef: any) => void;
  focus: (viewRef: any) => void;
  clearText: (viewRef: any) => void;
  toggleCancelButton: (viewRef: any, flag: boolean) => void;
  setText: (viewRef: any, text: string) => void;
  cancelSearch: (viewRef: any) => void;
}
